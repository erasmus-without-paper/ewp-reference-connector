...
public class EwpConstants {
    ...
    public static final String MOBILITIES_VERSION = "0.11.0";
    public static final String IIAS_VERSION = "2.0.0";
    ...
    public static final String MOBILITIES_CLIENT_VERSION = "0.11.0";
